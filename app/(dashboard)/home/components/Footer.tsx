        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <p className="flex items-center">
              ...
              <a
                href="mailto:cukurdere@cukurderesondaj.com.tr"
            ...
            <div className="mb-4">
              <ul>
                ...
                <li className="mb-2">                  <FaMapMarkerAlt className="inline-block mr-2" />{" "}
                 {t("cityCountry")}</li>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" legacyBehavior>
                  <a className="hover:text-red-500">{t("home")}</a>
                </Link>
              </li>
              <li>
                <Link href="/about" legacyBehavior>
                  <a className="hover:text-red-500">{t("about")}</a>
                </Link>
              </li>
              <li>
                <Link href="/services" legacyBehavior>
                  <a className="hover:text-red-500">{t("services")}</a>
                </Link>
              </li>
              <li>
                <Link href="/references" legacyBehavior>
                  <a className="hover:text-red-500">{t("references")}</a>
                </Link>
              </li>
              <li>
                <Link href="/quality" legacyBehavior>
                  <a className="hover:text-red-500">{t("qualityPolicy")}</a>
                </Link>
              </li>
              <li>
                <Link href="/isg" legacyBehavior>
                  <a className="hover:text-red-500">{t("hseAndEnvironment")}</a>
                </Link>
              </li>
              <li>
                <Link href="/contact" legacyBehavior>
                  <a className="hover:text-red-500">{t("contact")}</a>
                </Link>
              </li>
            </ul>
          </div>
